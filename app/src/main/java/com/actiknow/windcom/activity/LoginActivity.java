                        ...
                        public void onResponse (String response) {
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    String message = jsonObj.getString (AppConfigTags.MESSAGE);
                                    if (! error) {
                                        appDetailsPref.putStringPref (LoginActivity.this, AppDetailsPref.RESPONDANT_NAME, jsonObj.getString (AppConfigTags.RESPONDANT_NAME));
                                        appDetailsPref.putStringPref (LoginActivity.this, AppDetailsPref.RESPONDANT_EMAIL, jsonObj.getString (AppConfigTags.RESPONDANT_EMAIL));
                                        appDetailsPref.putStringPref (LoginActivity.this, AppDetailsPref.LOGIN_KEY, jsonObj.getString (AppConfigTags.RESPONDANT_LOGIN_KEY));
